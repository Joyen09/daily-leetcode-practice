...
## LeetCode 題目練習
- 題目編號: 388
- 題目：[Longest Absolute File Path](https://leetcode.com/problems/longest-absolute-file-path)
- 難度：Medium
- 相關標籤：String, Stack, Depth-First Search
...
1. 相關演算法：
   - 
Depth-First Search   - Stack   - String
