...
## LeetCode 題目練習
- 題目編號: 2479
- 題目：[Meeting Rooms III](https://leetcode.com/problems/meeting-rooms-iii)
- 難度：Hard
- 相關標籤：Array, Hash Table, Sorting, Heap (Priority Queue), Simulation
...
1. 相關演算法：
   - 
Simulation   - Sorting   - Heap (Priority Queue)   - Hash Table   - Array
